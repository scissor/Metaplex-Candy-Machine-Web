...
import { Avatar, CardMedia, Container, Snackbar } from '@material-ui/core';
    ...
    <Container style={{ marginTop: 100 }}>
      <Container maxWidth="xs" style={{ position: 'relative' }}>
        ...
        >
          <Typography
            align="center"
            style={{ marginTop: 5, marginBottom: 30, color: 'white', fontSize: 25 }}
          >
          ...
          >
            <CardMedia
              component="img"
              style={{ height: "128px", width: '128px', marginBottom: 30 }}
              image="anya.png"
              alt="green iguana"
            />
          </Grid>
